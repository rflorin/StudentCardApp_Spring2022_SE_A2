...
class StudentModel {
	...
	getStudents(sortParameters, pageParameters, filterParameters) {
		...
		let response = ResponseHelper.createResponse(sortParameters, pageParameters, filterParameters);
		//The totalpages parameter is hard coded to 5, but this is incorrect.
		response.pageparameters.totalpages = 5;
		response.data = studentsSorted;
